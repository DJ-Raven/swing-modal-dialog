...
public abstract class AbstractDrawerLineStyleRenderer {
    ...
    public abstract void draw(Graphics2D g2, JComponent component, int startX, int startY, int endX, int endY, int[] subMenuLocation, int selectedIndex, boolean isLeftToRight);

    public void drawArrow(Graphics2D g2, JComponent component, int width, int height, float animate, boolean isSelected, boolean isLeftToRight) {
